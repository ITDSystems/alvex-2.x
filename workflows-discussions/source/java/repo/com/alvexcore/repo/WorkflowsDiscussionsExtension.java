...
public class WorkflowsDiscussionsExtension extends RepositoryExtension {
	...
	final static QName[] DISCUSSIONS_STORAGE_PATH = {
	...
	final static QName[] DISCUSSIONS_STORAGE_TYPES = {
	...
	private void initializeStorage() throws Exception {
		NodeRef node = createPath(DISCUSSIONS_STORAGE_PATH, null,
				DISCUSSIONS_STORAGE_TYPES);
		PermissionService permissionService = ((RepositoryExtensionRegistry) this.registry)
