...
(function()
{
  ...
  /**
    ...
    * @return {ITD.TaskEditHeader} The new TaskEditHeader instance
    * @constructor
    */
   ITD.TaskEditHeader = function TaskEditHeader_constructor(htmlId)
   {
      ITD.TaskEditHeader.superclass.constructor.call(this, htmlId, ["button"]);

      // Re-register with our own name
      this.name = "ITD.TaskEditHeader";

      // Instance variables
      this.options = YAHOO.lang.merge(this.options, ITD.TaskEditHeader.superclass.options);
   ...
   YAHOO.extend(ITD.TaskEditHeader, Alfresco.component.ShareFormManager,
   {
