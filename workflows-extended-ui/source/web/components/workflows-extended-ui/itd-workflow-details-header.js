 ...
 *
 * @namespace ITD
 * @class ITD.WorkflowDetailsHeader
 */
(function()
{
   /**
    ...
    * @return {ITD.WorkflowDetailsHeader} The new WorkflowDetailsHeader instance
    * @constructor
    */
   ITD.WorkflowDetailsHeader = function WorkflowDetailsHeader_constructor(htmlId)
   {
      ITD.WorkflowDetailsHeader.superclass.constructor.call(this, "ITD.WorkflowDetailsHeader", htmlId, ["button", "container", "datasource", "datatable"]);
   ...
   YAHOO.extend(ITD.WorkflowDetailsHeader, Alfresco.component.Base,
   {
