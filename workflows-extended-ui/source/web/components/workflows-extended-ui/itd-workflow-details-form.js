...
(function()
{
    ...
    * @return {ITD.WorkflowForm} The new WorkflowForm instance
    * @constructor
    */
   ITD.WorkflowForm = function WorkflowForm_constructor(htmlId)
   {
debugger;
      ITD.WorkflowForm.superclass.constructor.call(this, "ITD.WorkflowForm", htmlId, ["button", "container", "datasource", "datatable"]);
      this.isReady = false;
      this.workflow = null;
      this.currentTasks = [];
      this.historyTasks = [];
   ...
   YAHOO.extend(ITD.WorkflowForm, Alfresco.component.Base,
   {
      /**
