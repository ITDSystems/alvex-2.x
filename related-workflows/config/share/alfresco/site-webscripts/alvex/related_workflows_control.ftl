...
<script type="text/javascript" src="${page.url.context}/res/components/alvex/related-workflows.js"></script>
<link rel="stylesheet" type="text/css" href="${page.url.context}/res/components/alvex/related-workflows.css" />
