 ...
 *
 * This file is derived from Alfresco and is part of Alvex
 *
...
(function()
{
    ...
    * @return {ITD.CreateSite} The new instance
    * @constructor
    */
   ...
   YAHOO.extend(Alvex.CreateDocRegSite, Alfresco.component.Base,
   {
      ...
      _modifyDialog: function CreateSite__modifyDialog()
      {
         ...
         var privateEl = Dom.get(this.id + '-isPrivate').parentNode.parentNode;
         publicEl.parentNode.removeChild(publicEl);
