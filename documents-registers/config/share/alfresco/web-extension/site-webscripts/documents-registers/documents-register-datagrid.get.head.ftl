...
<script type="text/javascript" src="${page.url.context}/res/components/alvex/simple-dialog.js"></script>
<script type="text/javascript" src="${page.url.context}/res/components/alvex/interval-calendar.js"></script>
