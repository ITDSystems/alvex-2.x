...
package ru.itdsystems.alfresco.module.evaluators;
...
public class SharePageEvaluator implements ExtensionModuleEvaluator
{
	...
	public boolean applyModule(RequestContext context, Map<String, String> evaluationProperties)
	{
		...
		String targetPage = evaluationProperties.get(PAGE_PROP);
		return (targetPage != null && targetPage.equals(currPage));
	}

	public String[] getRequiredProperties()
	{
		return new String[] { PAGE_PROP};
	}
}
