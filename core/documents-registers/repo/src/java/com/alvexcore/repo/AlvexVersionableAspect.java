...
/**
 * Alvex custom implementaion extending default versionable aspect
 * 
 */
public class AlvexVersionableAspect implements ContentServicePolicies.OnContentUpdatePolicy, 
                                          ...
                                          DictionaryListener
{
    protected static Log logger = LogFactory.getLog(AlvexVersionableAspect.class);
   ...
   /**
    ...
    // TODO: may be it should be converted into "ifAtLeastOnePropChanged"
