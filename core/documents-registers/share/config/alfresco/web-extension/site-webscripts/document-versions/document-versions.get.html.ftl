<@standalone>
   ...
   <@markup id="js">
      ...
      <@script type="text/javascript" src="${url.context}/res/components/alvex/document-versions/alvex-document-versions.js" group="document-details"/>
      <@script type="text/javascript" src="${url.context}/res/modules/document-details/revert-version.js" group="document-details"/>
      <@script type="text/javascript" src="${url.context}/res/components/alvex/document-versions/alvex-historic-properties-viewer.js" group="document-details"/>
   </@>
            ...
            <#else>
               ...
               <div id="${el}-body" class="document-versions document-details-panel">
                  <h2 id="${el}-heading" class="thin dark">
                     ...
                     <#if allowNewVersionUpload && hasContent>
