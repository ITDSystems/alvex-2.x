...
(function()
{
    ...
    * @return {Alvex.DocumentVersions} The new component instance
    * @constructor
    */
   Alvex.DocumentVersions = function DocumentVersions_constructor(htmlId)
   {
      Alvex.DocumentVersions.superclass.constructor.call(this, "Alvex.DocumentVersions", htmlId, ["datasource", "datatable", "paginator", "history", "animation"]);

      YAHOO.Bubbling.on("metadataRefresh", this.doRefresh, this);
      return this;
   };

   YAHOO.extend(Alvex.DocumentVersions, Alfresco.component.Base,
   {
      /**
      ...
      options:
      {
         ...
         /**
          * Tells if the node has content that can be uploaded or downloaded.
          *
          * @property hasContent
          * @type boolean
          */
      ...
      onRevertVersionComplete: function DocumentVersions_onRevertVersionComplete()
      {
         ...
         // TODO: quite ugly, but it's the only option to ensure all forms on the page are reloaded
      ...
      onViewHistoricPropertiesClick: function DocumentVersions_onViewHistoricPropertiesClick(nodeRef)
      {
         ...
         Alvex.module.getHistoricPropertiesViewerInstance().show(
         {
            filename: this.latestVersion.name,
