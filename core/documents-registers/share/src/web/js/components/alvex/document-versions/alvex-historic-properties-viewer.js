...
if (typeof Alvex.module === "undefined" || !Alvex.module)
{
	Alvex.module = {};
}
 ...
 *
 * @namespace Alvex.module
 * @class Alvex.module.HistoricPropertiesViewer
 */
...
(function()
{
    ...
    * please use Alvex.module.getHistoricPropertiesViewerInstance() instead.
    *
    * @param {string} htmlId The HTML id of the parent element
    * @return {Alvex.module.HistoricPropertiesViewer} The new HistoricPropertiesViewer instance
    * @constructor
    * @private
    */
   Alvex.module.HistoricPropertiesViewer = function(containerId)
   {
      this.name = "Alvex.module.HistoricPropertiesViewer";
      this.id = containerId;

      var instance = Alfresco.util.ComponentManager.get(this.id);
      if (instance !== null)
      {
         throw new Error("An instance of Alvex.module.HistoricPropertiesViewer already exists.");
      }
   ...
   Alvex.module.HistoricPropertiesViewer.prototype =
   {
      ...
      show: function HPV_show(config)
      {
         ...
         var documentVersions = Alfresco.util.ComponentManager.findFirst("Alvex.DocumentVersions");
         if (documentVersions) {
      ...
      {
         var dv = Alfresco.util.ComponentManager.findFirst("Alvex.DocumentVersions");
         var menuContainer = Dom.get(this.id + "-versionNav-menu"),
            ...
            currentTitle = dv.msg("historicProperties.menu.title", this.showConfig.latestVersion.label),
         ...
         for (i in this.versions) {
            var version = this.versions[i],
               title = dv.msg("historicProperties.menu.title", version.label);
         ...
         // Inject item headers
         currentVersionHeader.innerHTML = dv.msg("historicProperties.menu.current");
         previousVersionHeader.innerHTML = dv.msg("historicProperties.menu.previous");
      ...
      setMenuTitle: function HPV_setMenuTitle(title){
         ...
         if (!title) {
            if (this.showConfig.nodeRef === this.showConfig.latestVersion.nodeRef) {
               ...
               title = dv.msg("historicProperties.menu.title.latest",label);
      ...
      _applyConfig: function HPV__applyConfig()
      {
         ...
         var header = dv.msg("historicProperties.dialogue.header", "<strong>" + this.showConfig.filename + "</strong>");
...
Alvex.module.getHistoricPropertiesViewerInstance = function()
{
   var instanceId = "alvex-historicPropertiesViewer-instance";
   return Alfresco.util.ComponentManager.get(instanceId) || new Alvex.module.HistoricPropertiesViewer(instanceId);
}
