...
public abstract class AlvexActivitiListener implements InitializingBean {
	...
	@Required
	public void setAlvexPreParseListener(AlvexPreParseListener preParseListener) {
		this.alvexPreParseListener = preParseListener;
	}
	...
	public void afterPropertiesSet() throws Exception {
		alvexPreParseListener.addListener(this);
	}
