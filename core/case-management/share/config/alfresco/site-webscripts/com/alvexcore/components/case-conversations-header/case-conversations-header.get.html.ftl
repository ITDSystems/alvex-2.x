<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/components/alvex/case-conversations-header.css" group="workflow"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/components/alvex/case-conversations-header.js" group="workflow"/>
...
<@markup id="html">
   <@uniqueIdDiv>
      <div class="page-title theme-bg-color-1 theme-border-1" style="line-height: 32px;">
         ...
         <span id="${el}-body" class="case-conversations-toolbar toolbar">
