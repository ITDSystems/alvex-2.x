...
(function()
{
	...
	*/
	...
	/**
	* CaseConversationsHeader constructor.
	*
	* @param {String} htmlId The HTML id of the parent element
	* @return {Alvex.CaseConversationsHeader} The new CaseConversationsHeader instance
	* @constructor
	*/
	Alvex.CaseConversationsHeader = function TDH_constructor(htmlId)
	{
		Alvex.CaseConversationsHeader.superclass.constructor.call(this, "Alvex.CaseConversationsHeader", htmlId, ["button"]);
	...
	YAHOO.extend(Alvex.CaseConversationsHeader, Alfresco.component.Base,
	{
		onReady: function()
		{
			var me = this;
