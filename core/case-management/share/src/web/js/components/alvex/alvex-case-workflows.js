...
(function()
{
	...
	/**
	 * Dashboard CaseWorkflows constructor.
	 *
	 * @param {String} htmlId The HTML id of the parent element
	 * @return {Alvex.CaseWorkflows} The new component instance
	 * @constructor
	 */
	Alvex.CaseWorkflows = function CaseWorkflows_constructor(htmlId)
	{
		Alvex.CaseWorkflows.superclass.constructor.call(this, "Alvex.CaseWorkflows", htmlId,
	 ...
	 */
	YAHOO.extend(Alvex.CaseWorkflows, Alfresco.component.Base);

	/**
	 * Augment prototype with Common Workflow actions to reuse createFilterURLParameters
	 */
	YAHOO.lang.augmentProto(Alvex.CaseWorkflows, Alfresco.action.WorkflowActions);

	/**
	 * Augment prototype with main class implementation, ensuring overwrite is enabled
	 */
	YAHOO.lang.augmentObject(Alvex.CaseWorkflows.prototype,
			{
				/**
				 ...
				 * @method onReady
				 */
				onReady: function CaseWorkflows_onReady()
				{
					var me = this;
				 ...
				 */
				onPreferencesLoaded: function CaseWorkflows_onPreferencesLoaded(p_response)
				{
					...
					dataTable.doBeforeLoadData = function CaseWorkflows_doBeforeLoadData(sRequest, oResponse, oPayload)
					{
				 ...
				 */
				onFilterSelected: function CaseWorkflows_onFilterSelected(p_sType, p_aArgs)
				{
				 ...
				 * @param p_aArgs {array} Event arguments
				 */
				onSorterSelected: function CaseWorkflows_onSorterSelected(p_sType, p_aArgs)
				{
					var menuItem = p_aArgs[1];
				...
				getDataSourceURL: function()
				{
					...
					var webscript = YAHOO.lang.substitute("api/alvex/case/{caseId}/workflows?exclude={exclude}",
							{
				 ...
				 */
				renderCellIcons: function CaseWorkflows_onReady_renderCellIcons(elCell, oRecord, oColumn, oData)
				{
				 ...
				 */
				renderCellWorkflowInfo: function CaseWorkflows_onReady_renderCellTaskInfo(elCell, oRecord, oColumn, oData)
				{
					var workflow = oRecord.getData();
				 ...
				 */
				renderCellActions: function CaseWorkflows_onReady_renderCellActions(elCell, oRecord, oColumn, oData)
				{
					var data = oRecord.getData();
					...
					desc += '<div class="' + clb + '"><a href="" ' + 'class="alvex-case-workflow-action ' + this.id + '-action-link" '
							+ 'title="' + msg + '"><span>' + msg + '</span></a></div>';
					desc += '</div>';
