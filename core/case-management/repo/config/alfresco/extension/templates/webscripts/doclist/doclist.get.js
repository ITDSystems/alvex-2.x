...
function getDoclist()
{
   ...
   var allNodes = [],
      ...
      // Add support for date range in 'all' filter
      var argDays = args.days;
      if( (filter == "all") && (argDays !== null) && !isNaN(argDays) )
      {
         var dayCount = argDays;
         var date = new Date();
         ...
         filterParams.query += " +@cm\\:modified:[" + fromQuery + "T00\\:00\\:00.000 TO " + toQuery + "T23\\:59\\:59.999]";
      }
   ...
   if ((filter || "path") == "path")
   {
      ...
      if (parentNode !== null)
      {
         ...
         var sortField = (args.sortField == null ? "cm:modified" : args.sortField),
            sortAsc = (((args.sortAsc == null) || (args.sortAsc == "false")) ? false : true);
