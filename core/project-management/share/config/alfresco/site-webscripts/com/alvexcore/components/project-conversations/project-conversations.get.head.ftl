...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/alvex/project-conversations.css" />
...
<@script type="text/javascript" src="${url.context}/res/components/alvex/project-conversations.js" />