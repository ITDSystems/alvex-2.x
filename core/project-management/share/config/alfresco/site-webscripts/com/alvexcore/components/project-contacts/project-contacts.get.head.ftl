...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/alvex/project-contacts.css" />
...
<@script type="text/javascript" src="${url.context}/res/components/alvex/project-contacts.js" />